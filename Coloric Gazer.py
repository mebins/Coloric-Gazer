...
pygame.init()
pygame.display.set_caption("Coloric Gazer")
clock = pygame.time.Clock()
r = 0
g = 0
b = 0
color_mode = 0
color_spectrum_image = pygame.image.load("color_spectrum.jpg")
color_rect = color_spectrum_image.get_rect()
...
while True:
    ...
    screen.blit(color_spectrum_image, color_rect)

    color_rect.center = pygame.mouse.get_pos()
    color_spectrum_image.set_alpha(100)
    pygame.display.flip()
    clock.tick(10)
